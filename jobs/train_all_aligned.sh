...
# Server A: GPU 0,3 available (1,2 occupied by vLLM)
# 2 GPUs × bs=1 × ga=2 = effective batch 4 (matches GUI-Actor's 4 GPU × bs=1 × ga=1)
...
# ~225K / 4 = ~56K optimizer steps (1 epoch)
CUDA_VISIBLE_DEVICES="0,3" torchrun --nproc_per_node=2 \
