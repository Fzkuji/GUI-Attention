"""
ScreenSpot-v2 evaluation using saccade foveation (v4).

Dataset: HongxinLi/ScreenSpot_v2 on HuggingFace (reformatted, normalized bbox)
...
def main():
    parser = argparse.ArgumentParser(description="ScreenSpot-v2 eval (saccade foveation v4)")

    parser.add_argument("--checkpoint", type=str, required=True)
    parser.add_argument("--base_model", type=str, default="Qwen/Qwen2.5-VL-3B-Instruct")

    parser.add_argument("--dataset_name", type=str, default="HongxinLi/ScreenSpot_v2")
